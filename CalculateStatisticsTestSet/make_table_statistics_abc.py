...
#Result:
result = open("/home/pjohri1/ModelRejection/testset_100kb_" + str(win_size) + ".stats", 'w+')
...
for s_folder in l_folders:
    ...
    if "const" in s_folder:
        f_stats = open("/scratch/pjohri1/ModelRejection/simulations/const_rates/" + s_folder + "_stats/" + s_folder + "_" + str(win_size) + ".stats", 'r')
    elif "var" in s_folder:
        f_stats = open("/scratch/pjohri1/ModelRejection/simulations/var_rates/" + s_folder + "_stats/" + s_folder + "_" + str(win_size) + ".stats", 'r')
    d_stats = {}
    for line in f_stats:
        line1 = line.strip('\n')
        line2 = line1.split('\t')
    ...
    if "const" in s_folder:
        f_div = open("/scratch/pjohri1/ModelRejection/simulations/const_rates/" + s_folder + "_stats/" + s_folder + ".divergence", 'r')
    elif "var" in s_folder:
        f_div = open("/scratch/pjohri1/ModelRejection/simulations/var_rates/" + s_folder + "_stats/" + s_folder + ".divergence", 'r')
    ...
    #read lambda file:
    if "const" in s_folder:
        f_div = open("/scratch/pjohri1/ModelRejection/simulations/const_rates/" + s_folder + "_stats/" + s_folder + "_lambda.divergence", 'r')
    elif "var" in s_folder:
        f_div = open("/scratch/pjohri1/ModelRejection/simulations/var_rates/" + s_folder + "_stats/" + s_folder + "_lambda.divergence", 'r')
    d_mean_stats["lambda"] = []
    for line in f_div:
        line1 = line.strip('\n')
        line2 = line1.split('\t')
